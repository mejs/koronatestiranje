...
echo $output | jq '.' > $destFolder"koronaIT.json"
sed -i "s/\\\\\\\/\\\/g" koronaIT.json
sed -i 's/"{\\"color/\{"color/g' koronaIT.json
sed -i 's/\\"\\}/\"}/g' koronaIT.json
sed -i 's/"{"c/\{"c/g' koronaIT.json
sed -i 's/or\\":\\"/\lor":"/g' koronaIT.json
sed -i 's/\\",\\"/\","/g' koronaIT.json
sed -i 's/Class\\":\\"Drop","iconUrl\\":\\/\Class":"Drop","iconUrl":/g' koronaIT.json
sed -i 's/png\\}"/\png"}/g' koronaIT.json
